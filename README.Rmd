...
`project12pkg` provides a modular workflow for identifying and visualizing marker genes from single-cell RNA-seq data.

The package allows you to:

- Filter low-expression genes based on detection rate  
- Perform one-vs-rest statistical testing per cell type  
- Compute log2 fold changes, Wilcoxon p-values, and BH-adjusted p-values  
